...
export class ApiextensionsV1Api {
    ...
    public async createCustomResourceDefinition(
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1CustomResourceDefinition }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1CustomResourceDefinition }>(
                (resolve, reject) => {
    ...
    public async deleteCustomResourceDefinition(
        ...
        const localVarPath =
            this.basePath +
            '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async listCustomResourceDefinition(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1CustomResourceDefinitionList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async patchCustomResourceDefinitionStatus(
        ...
        const localVarPath =
            this.basePath +
            '/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
