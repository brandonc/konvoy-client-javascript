...
export class StorageV1beta1Api {
    ...
    public async createCSIDriver(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CSIDriver }>(
                (resolve, reject) => {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async createStorageClass(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1StorageClass }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async createVolumeAttachment(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1VolumeAttachment }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async deleteCSIDriver(
        ...
        const localVarPath =
            this.basePath +
            '/apis/storage.k8s.io/v1beta1/csidrivers/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async deleteCSINode(
        ...
        const localVarPath =
            this.basePath +
            '/apis/storage.k8s.io/v1beta1/csinodes/{name}'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
     ...
     * @param body
     */
    public async deleteCollectionCSIDriver(
        pretty?: string,
     ...
     * @param body
     */
    public async deleteCollectionCSINode(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        dryRun?: string,
     ...
     * @param body
     */
    public async deleteCollectionStorageClass(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        dryRun?: string,
     ...
     * @param body
     */
    public async deleteCollectionVolumeAttachment(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        dryRun?: string,
     ...
     * @param body
     */
    public async deleteStorageClass(
        name: string,
        pretty?: string,
        dryRun?: string,
        gracePeriodSeconds?: number,
        ...
        const localVarPath =
            this.basePath +
            '/apis/storage.k8s.io/v1beta1/storageclasses/{name}'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
     ...
     * @param body
     */
    public async deleteVolumeAttachment(
        name: string,
        pretty?: string,
        dryRun?: string,
        gracePeriodSeconds?: number,
        ...
        const localVarPath =
            this.basePath +
            '/apis/storage.k8s.io/v1beta1/volumeattachments/{name}'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
    ...
    public async listCSIDriver(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CSIDriverList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async listCSINode(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CSINodeList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async listStorageClass(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1StorageClassList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listVolumeAttachment(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1VolumeAttachmentList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchStorageClass(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchVolumeAttachment(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     * @param _export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18.
     */
    public async readVolumeAttachment(
        name: string,
        pretty?: string,
        exact?: boolean,
        _export?: boolean,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceStorageClass(
        name: string,
        body: V1beta1StorageClass,
        pretty?: string,
        dryRun?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceVolumeAttachment(
        name: string,
        body: V1beta1VolumeAttachment,
        pretty?: string,
        dryRun?: string,
