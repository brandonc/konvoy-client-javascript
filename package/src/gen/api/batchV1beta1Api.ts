...
export class BatchV1beta1Api {
     ...
     */
    public async createNamespacedCronJob(
        namespace: string,
        body: V1beta1CronJob,
        pretty?: string,
        dryRun?: string,
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1beta1CronJob }> {
        const localVarPath =
            this.basePath +
            '/apis/batch/v1beta1/namespaces/{namespace}/cronjobs'.replace(
                '{' + 'namespace' + '}',
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CronJob }>(
                (resolve, reject) => {
     ...
     * @param body
     */
    public async deleteCollectionNamespacedCronJob(
        namespace: string,
        pretty?: string,
     ...
     * @param body
     */
    public async deleteNamespacedCronJob(
        name: string,
        namespace: string,
        pretty?: string,
        dryRun?: string,
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listCronJobForAllNamespaces(
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        labelSelector?: string,
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CronJobList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     */
    public async patchNamespacedCronJob(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedCronJobStatus(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     */
    public async readNamespacedCronJob(
        name: string,
        namespace: string,
        pretty?: string,
        exact?: boolean,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readNamespacedCronJobStatus(
        name: string,
        namespace: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedCronJob(
        name: string,
        namespace: string,
        body: V1beta1CronJob,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedCronJobStatus(
        name: string,
        namespace: string,
        body: V1beta1CronJob,
        pretty?: string,
