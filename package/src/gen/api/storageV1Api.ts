...
export class StorageV1Api {
    ...
    public async createStorageClass(
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1StorageClass }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1StorageClass }>(
                (resolve, reject) => {
    ...
    public async createVolumeAttachment(
        ...
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1VolumeAttachment }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1VolumeAttachment }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async deleteStorageClass(
        ...
        const localVarPath =
            this.basePath +
            '/apis/storage.k8s.io/v1/storageclasses/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async deleteVolumeAttachment(
        ...
        const localVarPath =
            this.basePath +
            '/apis/storage.k8s.io/v1/volumeattachments/{name}'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
    ...
    public async listStorageClass(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1StorageClassList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async listVolumeAttachment(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1VolumeAttachmentList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchVolumeAttachmentStatus(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
        ...
        const localVarPath =
            this.basePath +
            '/apis/storage.k8s.io/v1/volumeattachments/{name}/status'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readVolumeAttachmentStatus(
        name: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1VolumeAttachment }> {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceVolumeAttachmentStatus(
        name: string,
        body: V1VolumeAttachment,
        pretty?: string,
        dryRun?: string,
