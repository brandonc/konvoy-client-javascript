...
export class NodeV1beta1Api {
     ...
     */
    public async createRuntimeClass(
        body: V1beta1RuntimeClass,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1RuntimeClass }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1RuntimeClass }>(
                (resolve, reject) => {
     ...
     * @param body
     */
    public async deleteCollectionRuntimeClass(
        pretty?: string,
     ...
     * @param body
     */
    public async deleteRuntimeClass(
        name: string,
        pretty?: string,
        dryRun?: string,
        gracePeriodSeconds?: number,
        ...
        const localVarPath =
            this.basePath +
            '/apis/node.k8s.io/v1beta1/runtimeclasses/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async listRuntimeClass(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1RuntimeClassList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     */
    public async patchRuntimeClass(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceRuntimeClass(
        name: string,
        body: V1beta1RuntimeClass,
        pretty?: string,
        dryRun?: string,
