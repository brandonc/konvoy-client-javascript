...
export class AutoscalingV1Api {
    ...
    public async createNamespacedHorizontalPodAutoscaler(
        ...
        const localVarPath =
            this.basePath +
            '/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers'.replace(
                '{' + 'namespace' + '}',
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1HorizontalPodAutoscaler }>(
                (resolve, reject) => {
    ...
    public async listHorizontalPodAutoscalerForAllNamespaces(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1HorizontalPodAutoscalerList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
