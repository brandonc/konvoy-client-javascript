...
export class AuthenticationV1beta1Api {
     ...
     */
    public async createTokenReview(
        body: V1beta1TokenReview,
        dryRun?: string,
        fieldManager?: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1TokenReview }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1TokenReview }>(
                (resolve, reject) => {
