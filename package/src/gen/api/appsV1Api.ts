...
export class AppsV1Api {
     ...
     */
    public async createNamespacedControllerRevision(
        namespace: string,
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1ControllerRevision }> {
        const localVarPath =
            this.basePath +
            '/apis/apps/v1/namespaces/{namespace}/controllerrevisions'.replace(
                '{' + 'namespace' + '}',
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1ControllerRevision }>(
                (resolve, reject) => {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async createNamespacedDaemonSet(
        namespace: string,
        body: V1DaemonSet,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1DaemonSet }> {
        const localVarPath =
            this.basePath +
            '/apis/apps/v1/namespaces/{namespace}/daemonsets'.replace(
                '{' + 'namespace' + '}',
                encodeURIComponent(String(namespace)),
            );
        let localVarQueryParameters: any = {};
    ...
    public async createNamespacedDeployment(
        ...
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1Deployment }> {
        const localVarPath =
            this.basePath +
            '/apis/apps/v1/namespaces/{namespace}/deployments'.replace(
                '{' + 'namespace' + '}',
                encodeURIComponent(String(namespace)),
            );
        let localVarQueryParameters: any = {};
    ...
    public async createNamespacedReplicaSet(
        ...
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1ReplicaSet }> {
        const localVarPath =
            this.basePath +
            '/apis/apps/v1/namespaces/{namespace}/replicasets'.replace(
                '{' + 'namespace' + '}',
                encodeURIComponent(String(namespace)),
            );
        let localVarQueryParameters: any = {};
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async createNamespacedStatefulSet(
        namespace: string,
        body: V1StatefulSet,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1StatefulSet }> {
        const localVarPath =
            this.basePath +
            '/apis/apps/v1/namespaces/{namespace}/statefulsets'.replace(
                '{' + 'namespace' + '}',
                encodeURIComponent(String(namespace)),
            );
        let localVarQueryParameters: any = {};
     ...
     * @param body
     */
    public async deleteCollectionNamespacedControllerRevision(
        namespace: string,
        pretty?: string,
     ...
     * @param body
     */
    public async deleteCollectionNamespacedDaemonSet(
        namespace: string,
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
     ...
     * @param body
     */
    public async deleteNamespacedControllerRevision(
        name: string,
        namespace: string,
        pretty?: string,
        dryRun?: string,
     ...
     * @param body
     */
    public async deleteNamespacedDaemonSet(
        name: string,
        namespace: string,
        pretty?: string,
        dryRun?: string,
     ...
     * @param body
     */
    public async deleteNamespacedStatefulSet(
        name: string,
        namespace: string,
        pretty?: string,
        dryRun?: string,
    ...
    public async listControllerRevisionForAllNamespaces(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1ControllerRevisionList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listDaemonSetForAllNamespaces(
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        labelSelector?: string,
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1DaemonSetList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async listDeploymentForAllNamespaces(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1DeploymentList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listNamespacedControllerRevision(
        namespace: string,
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listNamespacedDaemonSet(
        namespace: string,
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
    ...
    public async listNamespacedReplicaSet(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1ReplicaSetList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listNamespacedStatefulSet(
        namespace: string,
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1StatefulSetList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     */
    public async patchNamespacedControllerRevision(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedDaemonSet(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedDaemonSetStatus(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
    ...
    public async patchNamespacedDeploymentScale(
        ...
        force?: boolean,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1Scale }> {
        const localVarPath =
            this.basePath +
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedStatefulSet(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedStatefulSetScale(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedStatefulSetStatus(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     */
    public async readNamespacedControllerRevision(
        name: string,
        namespace: string,
        pretty?: string,
        exact?: boolean,
     ...
     * @param _export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18.
     */
    public async readNamespacedDaemonSet(
        name: string,
        namespace: string,
        pretty?: string,
        exact?: boolean,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readNamespacedDaemonSetStatus(
        name: string,
        namespace: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
     ...
     * @param _export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18.
     */
    public async readNamespacedStatefulSet(
        name: string,
        namespace: string,
        pretty?: string,
        exact?: boolean,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readNamespacedStatefulSetScale(
        name: string,
        namespace: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readNamespacedStatefulSetStatus(
        name: string,
        namespace: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedControllerRevision(
        name: string,
        namespace: string,
        body: V1ControllerRevision,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedDaemonSet(
        name: string,
        namespace: string,
        body: V1DaemonSet,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedDaemonSetStatus(
        name: string,
        namespace: string,
        body: V1DaemonSet,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedStatefulSet(
        name: string,
        namespace: string,
        body: V1StatefulSet,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedStatefulSetScale(
        name: string,
        namespace: string,
        body: V1Scale,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedStatefulSetStatus(
        name: string,
        namespace: string,
        body: V1StatefulSet,
        pretty?: string,
