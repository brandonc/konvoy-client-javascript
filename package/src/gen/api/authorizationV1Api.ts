...
export class AuthorizationV1Api {
    ...
    public async createNamespacedLocalSubjectAccessReview(
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1LocalSubjectAccessReview }> {
        const localVarPath =
            this.basePath +
            '/apis/authorization.k8s.io/v1/namespaces/{namespace}/localsubjectaccessreviews'.replace(
                '{' + 'namespace' + '}',
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1LocalSubjectAccessReview }>(
                (resolve, reject) => {
    ...
    public async createSelfSubjectAccessReview(
        ...
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1SelfSubjectAccessReview }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1SelfSubjectAccessReview }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async createSelfSubjectRulesReview(
        ...
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1SelfSubjectRulesReview }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1SelfSubjectRulesReview }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async createSubjectAccessReview(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1SubjectAccessReview }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
