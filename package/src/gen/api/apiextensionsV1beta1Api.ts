...
export class ApiextensionsV1beta1Api {
     ...
     */
    public async createCustomResourceDefinition(
        body: V1beta1CustomResourceDefinition,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1CustomResourceDefinition }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CustomResourceDefinition }>(
                (resolve, reject) => {
     ...
     * @param body
     */
    public async deleteCollectionCustomResourceDefinition(
        pretty?: string,
     ...
     * @param body
     */
    public async deleteCustomResourceDefinition(
        name: string,
        pretty?: string,
        dryRun?: string,
        gracePeriodSeconds?: number,
        ...
        const localVarPath =
            this.basePath +
            '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}'.replace(
                '{' + 'name' + '}',
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listCustomResourceDefinition(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CustomResourceDefinitionList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     */
    public async patchCustomResourceDefinition(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchCustomResourceDefinitionStatus(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
        ...
        const localVarPath =
            this.basePath +
            '/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/{name}/status'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
     ...
     */
    public async readCustomResourceDefinition(
        name: string,
        pretty?: string,
        exact?: boolean,
        _export?: boolean,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readCustomResourceDefinitionStatus(
        name: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1CustomResourceDefinition }> {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceCustomResourceDefinition(
        name: string,
        body: V1beta1CustomResourceDefinition,
        pretty?: string,
        dryRun?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceCustomResourceDefinitionStatus(
        name: string,
        body: V1beta1CustomResourceDefinition,
        pretty?: string,
        dryRun?: string,
