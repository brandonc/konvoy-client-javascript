...
export class SchedulingV1Api {
    ...
    public async createPriorityClass(
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1PriorityClass }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1PriorityClass }>(
                (resolve, reject) => {
    ...
    public async deletePriorityClass(
        ...
        const localVarPath =
            this.basePath +
            '/apis/scheduling.k8s.io/v1/priorityclasses/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async listPriorityClass(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1PriorityClassList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
