...
export class BatchV1Api {
     ...
     */
    public async createNamespacedJob(
        namespace: string,
        body: V1Job,
        pretty?: string,
        dryRun?: string,
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1Job }> {
        const localVarPath =
            this.basePath +
            '/apis/batch/v1/namespaces/{namespace}/jobs'.replace(
                '{' + 'namespace' + '}',
     ...
     * @param body
     */
    public async deleteCollectionNamespacedJob(
        namespace: string,
        pretty?: string,
     ...
     * @param body
     */
    public async deleteNamespacedJob(
        name: string,
        namespace: string,
        pretty?: string,
        dryRun?: string,
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listJobForAllNamespaces(
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        labelSelector?: string,
     ...
     */
    public async patchNamespacedJob(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedJobStatus(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     */
    public async readNamespacedJob(
        name: string,
        namespace: string,
        pretty?: string,
        exact?: boolean,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readNamespacedJobStatus(
        name: string,
        namespace: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedJob(
        name: string,
        namespace: string,
        body: V1Job,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedJobStatus(
        name: string,
        namespace: string,
        body: V1Job,
        pretty?: string,
