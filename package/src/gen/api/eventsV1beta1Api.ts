...
export class EventsV1beta1Api {
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1beta1Event }> {
        const localVarPath =
            this.basePath +
            '/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events'.replace(
                '{' + 'namespace' + '}',
     ...
     * @param body
     */
    public async deleteCollectionNamespacedEvent(
        namespace: string,
        pretty?: string,
    ...
    public async listEventForAllNamespaces(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1EventList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     */
    public async patchNamespacedEvent(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
