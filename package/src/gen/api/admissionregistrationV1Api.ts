...
export class AdmissionregistrationV1Api {
     ...
     */
    public async createMutatingWebhookConfiguration(
        body: V1MutatingWebhookConfiguration,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1MutatingWebhookConfiguration }> {
        const localVarPath =
            this.basePath + '/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations';
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1MutatingWebhookConfiguration }>(
                (resolve, reject) => {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async createValidatingWebhookConfiguration(
        body: V1ValidatingWebhookConfiguration,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1ValidatingWebhookConfiguration }> {
        const localVarPath =
            this.basePath + '/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1ValidatingWebhookConfiguration }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param body
     */
    public async deleteCollectionMutatingWebhookConfiguration(
        pretty?: string,
     ...
     * @param body
     */
    public async deleteCollectionValidatingWebhookConfiguration(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        dryRun?: string,
     ...
     * @param body
     */
    public async deleteMutatingWebhookConfiguration(
        name: string,
        pretty?: string,
        dryRun?: string,
        gracePeriodSeconds?: number,
        ...
        const localVarPath =
            this.basePath +
            '/apis/admissionregistration.k8s.io/v1/mutatingwebhookconfigurations/{name}'.replace(
                '{' + 'name' + '}',
     ...
     * @param body
     */
    public async deleteValidatingWebhookConfiguration(
        name: string,
        pretty?: string,
        dryRun?: string,
        gracePeriodSeconds?: number,
        ...
        const localVarPath =
            this.basePath +
            '/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listMutatingWebhookConfiguration(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1MutatingWebhookConfigurationList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listValidatingWebhookConfiguration(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
     ...
     */
    public async patchMutatingWebhookConfiguration(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchValidatingWebhookConfiguration(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     */
    public async readMutatingWebhookConfiguration(
        name: string,
        pretty?: string,
        exact?: boolean,
        _export?: boolean,
     ...
     * @param _export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18.
     */
    public async readValidatingWebhookConfiguration(
        name: string,
        pretty?: string,
        exact?: boolean,
        _export?: boolean,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceMutatingWebhookConfiguration(
        name: string,
        body: V1MutatingWebhookConfiguration,
        pretty?: string,
        dryRun?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceValidatingWebhookConfiguration(
        name: string,
        body: V1ValidatingWebhookConfiguration,
        pretty?: string,
        dryRun?: string,
