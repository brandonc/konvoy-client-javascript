...
export class NetworkingV1beta1Api {
     ...
     */
    public async createNamespacedIngress(
        namespace: string,
    ...
    ): Promise<{ response: http.IncomingMessage; body: NetworkingV1beta1Ingress }> {
        const localVarPath =
            this.basePath +
            '/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses'.replace(
                '{' + 'namespace' + '}',
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: NetworkingV1beta1Ingress }>(
                (resolve, reject) => {
     ...
     * @param body
     */
    public async deleteNamespacedIngress(
        name: string,
        namespace: string,
        pretty?: string,
        dryRun?: string,
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listIngressForAllNamespaces(
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        labelSelector?: string,
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: NetworkingV1beta1IngressList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listNamespacedIngress(
        namespace: string,
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
     ...
     */
    public async patchNamespacedIngress(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchNamespacedIngressStatus(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     */
    public async readNamespacedIngress(
        name: string,
        namespace: string,
        pretty?: string,
        exact?: boolean,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readNamespacedIngressStatus(
        name: string,
        namespace: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedIngress(
        name: string,
        namespace: string,
        body: NetworkingV1beta1Ingress,
        pretty?: string,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedIngressStatus(
        name: string,
        namespace: string,
        body: NetworkingV1beta1Ingress,
        pretty?: string,
