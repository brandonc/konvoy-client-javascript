...
export class AutoscalingV2beta2Api {
    ...
    public async createNamespacedHorizontalPodAutoscaler(
        ...
        const localVarPath =
            this.basePath +
            '/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers'.replace(
                '{' + 'namespace' + '}',
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V2beta2HorizontalPodAutoscaler }>(
                (resolve, reject) => {
    ...
    public async listHorizontalPodAutoscalerForAllNamespaces(
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V2beta2HorizontalPodAutoscalerList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
