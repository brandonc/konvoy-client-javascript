...
export class CertificatesV1beta1Api {
     ...
     */
    public async createCertificateSigningRequest(
        body: V1beta1CertificateSigningRequest,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1CertificateSigningRequest }> {
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1CertificateSigningRequest }>(
                (resolve, reject) => {
     ...
     * @param body
     */
    public async deleteCertificateSigningRequest(
        name: string,
        pretty?: string,
        dryRun?: string,
        ...
        const localVarPath =
            this.basePath +
            '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}'.replace(
                '{' + 'name' + '}',
     ...
     * @param body
     */
    public async deleteCollectionCertificateSigningRequest(
        pretty?: string,
     ...
     */
    public async patchCertificateSigningRequest(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public async patchCertificateSigningRequestStatus(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
        ...
        const localVarPath =
            this.basePath +
            '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
     ...
     */
    public async readCertificateSigningRequest(
        name: string,
        pretty?: string,
        exact?: boolean,
        _export?: boolean,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async readCertificateSigningRequestStatus(
        name: string,
        pretty?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1CertificateSigningRequest }> {
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceCertificateSigningRequest(
        name: string,
        body: V1beta1CertificateSigningRequest,
        pretty?: string,
        dryRun?: string,
     ...
     * @param pretty If \&#39;true\&#39;, then the output is pretty printed.
     */
    public async replaceCertificateSigningRequestApproval(
        name: string,
        body: V1beta1CertificateSigningRequest,
        dryRun?: string,
        fieldManager?: string,
        ...
        const localVarPath =
            this.basePath +
            '/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceCertificateSigningRequestStatus(
        name: string,
        body: V1beta1CertificateSigningRequest,
        pretty?: string,
        dryRun?: string,
