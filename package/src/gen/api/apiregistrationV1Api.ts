...
export class ApiregistrationV1Api {
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1APIService }> {
    ...
    public async deleteAPIService(
        ...
        const localVarPath =
            this.basePath +
            '/apis/apiregistration.k8s.io/v1/apiservices/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async listAPIService(
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1APIServiceList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async patchAPIServiceStatus(
        ...
        const localVarPath =
            this.basePath +
            '/apis/apiregistration.k8s.io/v1/apiservices/{name}/status'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
