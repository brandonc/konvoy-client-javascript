...
export class TemplatesGatekeeperShV1alpha1Api {
    ...
    public async deleteConstraintTemplate(
        ...
        const localVarPath =
            this.basePath +
            '/apis/templates.gatekeeper.sh/v1alpha1/constrainttemplates/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async listConstraintTemplate(
        ...
        body: ShGatekeeperTemplatesV1alpha1ConstraintTemplateList;
    }> {
        const localVarPath = this.basePath + '/apis/templates.gatekeeper.sh/v1alpha1/constrainttemplates';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
                ...
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(
                            body,
                            'ShGatekeeperTemplatesV1alpha1ConstraintTemplateList',
                        );
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
