...
export class NetworkingV1Api {
    ...
    public async createNamespacedNetworkPolicy(
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1NetworkPolicy }> {
        const localVarPath =
            this.basePath +
            '/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies'.replace(
                '{' + 'namespace' + '}',
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1NetworkPolicy }>(
                (resolve, reject) => {
    ...
    public async listNamespacedNetworkPolicy(
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1NetworkPolicyList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
