...
export class CoordinationV1beta1Api {
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1beta1Lease }> {
        const localVarPath =
            this.basePath +
            '/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases'.replace(
                '{' + 'namespace' + '}',
     ...
     * @param body
     */
    public async deleteNamespacedLease(
        name: string,
        namespace: string,
        pretty?: string,
        dryRun?: string,
    ...
    public async listLeaseForAllNamespaces(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1LeaseList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     */
    public async patchNamespacedLease(
        name: string,
        namespace: string,
        body: object,
        pretty?: string,
     ...
     */
    public async readNamespacedLease(
        name: string,
        namespace: string,
        pretty?: string,
        exact?: boolean,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replaceNamespacedLease(
        name: string,
        namespace: string,
        body: V1beta1Lease,
        pretty?: string,
