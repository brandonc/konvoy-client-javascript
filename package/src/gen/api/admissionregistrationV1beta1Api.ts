...
export class AdmissionregistrationV1beta1Api {
    ...
    public async createMutatingWebhookConfiguration(
        ...
        const localVarPath =
            this.basePath + '/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations';
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1MutatingWebhookConfiguration }>(
                (resolve, reject) => {
    ...
    public async createValidatingWebhookConfiguration(
        ...
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1ValidatingWebhookConfiguration }> {
        const localVarPath =
            this.basePath + '/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json', 'application/yaml', 'application/vnd.kubernetes.protobuf'];
        // give precedence to 'application/json'
    ...
    public async deleteMutatingWebhookConfiguration(
        ...
        const localVarPath =
            this.basePath +
            '/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async deleteValidatingWebhookConfiguration(
        ...
        const localVarPath =
            this.basePath +
            '/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{name}'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
