...
export class SchedulingV1beta1Api {
     ...
     */
    public async createPriorityClass(
        body: V1beta1PriorityClass,
        pretty?: string,
        dryRun?: string,
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1beta1PriorityClass }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1PriorityClass }>(
                (resolve, reject) => {
     ...
     * @param body
     */
    public async deleteCollectionPriorityClass(
        pretty?: string,
     ...
     * @param body
     */
    public async deletePriorityClass(
        name: string,
        pretty?: string,
        dryRun?: string,
        gracePeriodSeconds?: number,
        ...
        const localVarPath =
            this.basePath +
            '/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}'.replace(
                '{' + 'name' + '}',
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public async listPriorityClass(
        pretty?: string,
        allowWatchBookmarks?: boolean,
        _continue?: string,
        fieldSelector?: string,
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1beta1PriorityClassList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
     ...
     */
    public async patchPriorityClass(
        name: string,
        body: object,
        pretty?: string,
        dryRun?: string,
     ...
     */
    public async readPriorityClass(
        name: string,
        pretty?: string,
        exact?: boolean,
        _export?: boolean,
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public async replacePriorityClass(
        name: string,
        body: V1beta1PriorityClass,
        pretty?: string,
        dryRun?: string,
