...
export class RbacAuthorizationV1Api {
    ...
    ): Promise<{ response: http.IncomingMessage; body: V1ClusterRole }> {
    ...
    public async createClusterRoleBinding(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1ClusterRoleBinding }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async createNamespacedRole(
        ...
        fieldManager?: string,
        options: { headers: { [name: string]: string } } = { headers: {} },
    ): Promise<{ response: http.IncomingMessage; body: V1Role }> {
        const localVarPath =
            this.basePath +
            '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles'.replace(
                '{' + 'namespace' + '}',
    ...
    public async createNamespacedRoleBinding(
        ...
        const localVarPath =
            this.basePath +
            '/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/rolebindings'.replace(
                '{' + 'namespace' + '}',
                encodeURIComponent(String(namespace)),
            );
        let localVarQueryParameters: any = {};
    ...
    public async deleteClusterRole(
        ...
        const localVarPath =
            this.basePath +
            '/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}'.replace(
                '{' + 'name' + '}',
    ...
    public async deleteClusterRoleBinding(
        ...
        const localVarPath =
            this.basePath +
            '/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}'.replace(
                '{' + 'name' + '}',
                encodeURIComponent(String(name)),
            );
        let localVarQueryParameters: any = {};
    ...
    public async listClusterRole(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1ClusterRoleList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async listClusterRoleBinding(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1ClusterRoleBindingList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
    ...
    public async listNamespacedRoleBinding(
        ...
        return authenticationPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: V1RoleBindingList }>(
                (resolve, reject) => {
                    localVarRequest(localVarRequestOptions, (error, response, body) => {
                        if (error) {
                            reject(error);
