 ...
 */
export class IoMesosphereDexV1alpha1ConnectorSpecGithubRootCASecretRef {
    /**
    ...
    static getAttributeTypeMap() {
        return IoMesosphereDexV1alpha1ConnectorSpecGithubRootCASecretRef.attributeTypeMap;
    }
}
