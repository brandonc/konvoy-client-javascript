 ...
 */
export class IoMesosphereKommanderV1beta1ProjectList {
    /**
     ...
     */
    'items': Array<IoMesosphereKommanderV1beta1Project>;
    /**
    ...
    static attributeTypeMap: Array<{ name: string; baseName: string; type: string }> = [
        ...
        },
        {
            name: 'items',
            baseName: 'items',
            type: 'Array<IoMesosphereKommanderV1beta1Project>',
        },
        {
            name: 'kind',
            baseName: 'kind',
    ...
    static getAttributeTypeMap() {
        return IoMesosphereKommanderV1beta1ProjectList.attributeTypeMap;
    }
}
