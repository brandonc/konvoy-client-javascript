 ...
 */
export class IoMesosphereDexV1alpha1ConnectorSpecGithubClientSecretRef {
    /**
    ...
    static getAttributeTypeMap() {
        return IoMesosphereDexV1alpha1ConnectorSpecGithubClientSecretRef.attributeTypeMap;
    }
}
