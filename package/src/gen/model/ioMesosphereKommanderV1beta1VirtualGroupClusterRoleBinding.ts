 ...
 */
export class IoMesosphereKommanderV1beta1VirtualGroupClusterRoleBinding {
    /**
    ...
    static attributeTypeMap: Array<{ name: string; baseName: string; type: string }> = [
        ...
        },
        {
            name: 'spec',
            baseName: 'spec',
            type: 'IoMesosphereKommanderV1beta1VirtualGroupClusterRoleBindingSpec',
        },
    ];

    static getAttributeTypeMap() {
        return IoMesosphereKommanderV1beta1VirtualGroupClusterRoleBinding.attributeTypeMap;
    }
}
