 ...
 */
export class IoMesosphereDexV1alpha1ConnectorList {
    /**
     ...
     */
    'items': Array<IoMesosphereDexV1alpha1Connector>;
    /**
    ...
    static attributeTypeMap: Array<{ name: string; baseName: string; type: string }> = [
        ...
        },
        {
            name: 'items',
            baseName: 'items',
            type: 'Array<IoMesosphereDexV1alpha1Connector>',
        },
        {
            name: 'kind',
            baseName: 'kind',
    ...
    static getAttributeTypeMap() {
        return IoMesosphereDexV1alpha1ConnectorList.attributeTypeMap;
    }
}
