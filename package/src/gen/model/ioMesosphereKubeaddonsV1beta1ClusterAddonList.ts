...
*/
export class IoMesosphereKubeaddonsV1beta1ClusterAddonList {
    /**
    * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    */
    'apiVersion'?: string;
    /**
    * List of clusteraddons. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    */
    'items': Array<object>;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return IoMesosphereKubeaddonsV1beta1ClusterAddonList.attributeTypeMap;
    }
}
