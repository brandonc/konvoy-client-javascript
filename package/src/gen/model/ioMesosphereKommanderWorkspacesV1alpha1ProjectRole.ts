...
/**
 * Project is the Schema for the workspaces ProjectRole API
 */
export class IoMesosphereKommanderWorkspacesV1alpha1ProjectRole {
    /**
    ...
    'status'?: IoMesosphereKommanderWorkspacesV1alpha1ProjectRoleStatus;
    ...
    static attributeTypeMap: Array<{ name: string; baseName: string; type: string }> = [
        ...
        },
        {
            name: 'status',
            baseName: 'status',
            type: 'IoMesosphereKommanderWorkspacesV1alpha1ProjectRoleStatus',
        },
    ];

    static getAttributeTypeMap() {
        return IoMesosphereKommanderWorkspacesV1alpha1ProjectRole.attributeTypeMap;
    }
}
